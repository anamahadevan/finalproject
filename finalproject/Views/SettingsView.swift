    ...
    var body: some View {
        VStack{
            Form {
                ...
                Section{
                    Text("The Pomodoro Technique is a time management method based on 25-minute stretches of focused work broken by five-minute breaks. Then longer breaks, typically 15 to 30 minutes. Each work interval is called a pomodoro, the Italian word for tomato ")
